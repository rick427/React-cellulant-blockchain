                                        ...
                                        <div className="row">
                                            <div className="col-lg-6 col-md-6">
                                                <div className="why-we-different-text">
                                                    ...
                                                    <ul>
                                                        <li><i className="fa fa-check"></i>Creative flow</li>
                                                        <li><i className="fa fa-check"></i>Efficient Transactions</li>
                                                        <li><i className="fa fa-check"></i>Immutability</li>
                                                        <li><i className="fa fa-check"></i>Database</li>
                                                        <li><i className="fa fa-check"></i>Lister</li>
